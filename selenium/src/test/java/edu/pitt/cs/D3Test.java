...
public class D3Test {
  ...
  public void tEST1LINKS() {
    ...
    driver.manage().window().setSize(new Dimension(862, 950));
    {
  ...
  public void tEST3CATALOG() {
    ...
    {
      List<WebElement> elements = driver.findElements(By.xpath("//img[@src=\'/images/cat2.jpg\']"));
      assert(elements.size() > 0);
    }
  }
  @Test
  ...
  public void tEST4LISTING() {
    driver.get("https://cs1632.appspot.com/");
    driver.findElement(By.linkText("Catalog")).click();
    vars.put("itemCount", driver.findElements(By.xpath("//li[contains(@class, \'list-group-item\')]")).size());
